  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      for (let i = 0; i < imageFiles.length; i++) {
        imageUrls.push(`/placeholder.svg?height=300&width=400&text=Service+Image+${i + 1}`)
      }
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Create Your Service</h1>
          <p className="text-lg text-gray-600">
            Showcase your skills and start earning by offering your services to clients worldwide
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Fill in the details about the service you want to offer. Be specific and highlight what makes your service
              unique.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                />
                <p className="text-sm text-gray-500">Create a clear, descriptive title that explains what you offer</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-500">
                  Minimum 100 characters. Be detailed about what you offer and what's included.
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-500">Add relevant tags to help clients find your service</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                  ...
                  <div className="space-y-2">
                    <p className="text-sm text-gray-600">Upload images that showcase your service</p>
                    <input
                      type="file"
                      id="images"
                      multiple
                    ...
                    <p className="text-xs text-gray-500">Maximum 5 images, up to 10MB each</p>
                  </div>
                </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-6">
                ...
                >
                  {loading ? "Creating Service..." : user ? "Create Service" : "Sign Up & Create Service"}
                </Button>
                <Link href="/browse">
              ...
              {!user && (
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <p className="text-sm text-blue-800">
                    <strong>Note:</strong> You'll need to create an account to publish your service. Your service
                    details will be saved during the signup process.
                  </p>
                </div>
              )}
            </form>
