      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Follow these steps to set up your Supabase database for the
            freelance platform.
          </p>
        </div>
        ...
        <Card className="mb-6">
          ...
          <CardContent className="space-y-4">
            <p className="text-gray-600">
              Test if your Supabase connection is working properly.
            </p>
            ...
            {testResults && (
              <div
                className={`p-4 rounded-lg ${testResults.success ? 'bg-green-50' : 'bg-red-50'}`}
              >
        ...
        <Card className="mb-6">
          ...
          <CardContent className="space-y-4">
            <p className="text-gray-600">
              Verify that all database tables and policies are set up correctly.
            </p>
            ...
            {verificationResults && (
              <div
                className={`p-4 rounded-lg ${verificationResults.success ? 'bg-green-50' : 'bg-red-50'}`}
              >
                <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="grid grid-cols-3 gap-4 text-sm">
                      <div>
                        ...
                        <span className="ml-2 font-semibold">
                          {verificationResults.summary.total_tables}
                        </span>
                      </div>
                      <div>
                        <span className="text-gray-600">Existing:</span>
                        <span className="ml-2 font-semibold">
                          {verificationResults.summary.existing_tables}
                        </span>
                      </div>
                      <div>
                        <span className="text-gray-600">Working:</span>
                        <span className="ml-2 font-semibold">
                          {verificationResults.summary.working_tables}
                        </span>
                      </div>
                    </div>
                  </div>
        ...
        <Card className="mb-6">
          ...
          <CardContent className="space-y-4">
            <p className="text-gray-600">
              Set up storage buckets for file uploads (images, documents, etc.).
            </p>

            <Button onClick={setupStorage} disabled={loading === 'storage'}>
              {loading === 'storage' ? 'Setting up...' : 'Setup Storage'}
            </Button>

            {storageResults && (
              <div
                className={`p-4 rounded-lg ${storageResults.success ? 'bg-green-50' : 'bg-red-50'}`}
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <div className="mb-4">
                    ...
                    <div className="grid grid-cols-3 gap-4 text-sm">
                      <div>
                        ...
                        <span className="ml-2 font-semibold">
                          {storageResults.summary.total_buckets}
                        </span>
                      </div>
                      <div>
                        <span className="text-gray-600">Created:</span>
                        <span className="ml-2 font-semibold">
                          {storageResults.summary.created_buckets}
                        </span>
                      </div>
                      <div>
                        <span className="text-gray-600">Existing:</span>
                        <span className="ml-2 font-semibold">
                          {storageResults.summary.existing_buckets}
                        </span>
                      </div>
                    </div>
                  </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Try creating a user account and testing the order system.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Add some sample gigs and services to test the platform.
                  </p>
                </div>
              </div>
